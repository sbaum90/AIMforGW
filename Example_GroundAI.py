############################################################################
# this example script runs the AIMforGW.ParamEstimator_GroundAI code 
...
import ParamEstimator_GroundAI as AI_PE
...
fpath_out = "ExampleOutput/results_Example_GroundAI_"+timestamp_str+"/"
...
fo.write('# RUNNING WITH AIMforGW.ParamEstimator_GroundAII\n')
