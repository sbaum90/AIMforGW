############################################################################
# this example script runs the AIMforGW.ParamEstimator_LO_SpaceAI code
...
import ParamEstimator_LO_SpaceAI as AI_PE
...
fpath_out = "ExampleOutput/results_Example_LO_SpaceAI_"+timestamp_str+"/"
...
fo.write('# RUNNING WITH AIMforGW.ParamEstimator_LO_SpaceAI\n')
